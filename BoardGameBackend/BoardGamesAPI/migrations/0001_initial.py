# Generated by Django 4.0.6 on 2022-09-25 20:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='t_game',
            constraint=models.CheckConstraint(check=models.Q(('min_player__lt', django.db.models.expressions.F('max_player'))), name='min_player_lower_than_max'),
        ),
        migrations.AddConstraint(
            model_name='t_friend_list',
            constraint=models.CheckConstraint(check=models.Q(True), name='check_same_user_IDs'),
        ),
    ]
